...
** TODO Racket
#+begin_src racket :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.rkt :eval never-export :results output 
(displayln "TODO")
#+end_src
** Python
#+begin_src python :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.py :eval never-export :results output
...
count_intersections(sample_data[:-1], 10)
count_intersections(input_data[:-1], 1000)
#+end_src
...
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-1.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Part 2
** Description
...
** TODO Racket
#+begin_src racket :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.rkt :eval never-export :results output 
(displayln "TODO")
#+end_src
** TODO Python
#+begin_src python :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.py :eval never-export :results output 
def print_board(board):
   for line in board:
...
222111....
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-05 :var input_data=input-2021-05 :tangle /tmp/advent_of_code/aoc2021-05-2.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Inputs
** Sample
...
#+RESULTS[324f6b94b84da7ee0df2551db68dcf6cda4c9d2d]: sample-2021-05
#+begin_example
0,9 -> 5,9
8,0 -> 0,8
9,4 -> 3,4
