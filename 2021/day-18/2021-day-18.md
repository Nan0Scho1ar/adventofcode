...
[snailfish](https://en.wikipedia.org/wiki/Snailfish){target="_blank"}.
...
his *[math]{title="Snailfish math is snailfish math!"} homework*.
...
-   `[[[[`*`[9,8]`*`,1],2],3],4]` becomes
    `[[[[`*`0`*`,`*`9`*`],2],3],4]` (the `9` has no regular number to
    its left, so it is not added to any regular number).
-   `[7,[6,[5,[4,`*`[3,2]`*`]]]]` becomes
    `[7,[6,[5,[`*`7`*`,`*`0`*`]]]]` (the `2` has no regular number to
    its right, and so it is not added to any regular number).
-   `[[6,[5,[4,`*`[3,2]`*`]]],1]` becomes
    `[[6,[5,[`*`7`*`,`*`0`*`]]],`*`3`*`]`.
-   `[[3,[2,[1,`*`[7,3]`*`]]],[6,[5,[4,[3,2]]]]]` becomes
    `[[3,[2,[`*`8`*`,`*`0`*`]]],[`*`9`*`,[5,[4,[3,2]]]]]` (the pair
    `[3,2]` is unaffected because the pair `[7,3]` is further to the
