...
** TODO Racket
#+begin_src racket :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.rkt :eval never-export :results output 
(displayln "TODO")
#+end_src
** TODO Python
#+begin_src python :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.py :eval never-export :results output 
print("TODO")
#+end_src
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-1.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Part 2
** Description
...
** TODO Racket
#+begin_src racket :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.rkt :eval never-export :results output 
(displayln "TODO")
#+end_src
** TODO Python
#+begin_src python :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.py :eval never-export :results output 
print("TODO")
#+end_src
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-11 :var input_data=input-2021-11 :tangle /tmp/advent_of_code/aoc2021-11-2.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Inputs
** Sample
