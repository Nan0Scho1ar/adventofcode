...
tubes](https://en.wikipedia.org/wiki/Lava_tube){target="_blank"}. Parts
are even still volcanically active; small hydrothermal vents release
smoke into the caves that slowly [settles like
