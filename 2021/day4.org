...
** Racket
#+begin_src racket :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.rkt :eval never-export :results output 
(define (prep-data data)
    ...
    (list (map string->number (string-split (first chunks) ","))
          (for/list ([board (rest chunks)])
            (map string->number (string-split (string-replace board "\n" " ") " "))))))

(define (has-winner? board-states)
  (for*/first ([(state idx) (in-indexed board-states)]
              [win '(31 992 31744 1015808 32505856 1082401 2164802 4329604 8659208 17318416)]
...
(define (find-winner nums-called boards)
  (for*/fold ([states (build-list (length boards) (const 0))]
             ...
             ([num-called nums-called]
              [(board state-idx) (in-indexed boards)])
    #:break (first winner)
    (if (member num-called board)
        (let ([new-states
               (list-set states state-idx
                         (bitwise-ior (list-ref states state-idx)
                                      (arithmetic-shift 1 (index-of board num-called))))])
          (values new-states (flatten (list (has-winner? new-states) num-called))))
        (values states (flatten (list winner num-called))))))

(define (bingo-time data)
  (match-define (list nums-called boards) (prep-data data))
  (match-define (list winner-idx winner-state last-call) (find-winner nums-called boards))
...
** Python
#+begin_src python :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.py :eval never-export :results output
...
print(bingo_time(sample_data))
print(bingo_time(input_data))
#+end_src
...
: 10374
** Python v2
#+begin_src python :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1-2.py :eval never-export :results output
...
bingo_time(sample_data.split("\n\n"))
bingo_time(input_data.split("\n\n"))
#+end_src
...
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-1.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Part 2
** Description
...
** TODO Racket
#+begin_src racket :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.rkt :eval never-export :results output 
(displayln "TODO")
#+end_src
** Python
#+begin_src python :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.py :eval never-export :results output 
def solved(board):
    for i in range(0,5):
        row_valid = True
        column_valid = True
...
** TODO Rust
#+begin_src rust :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.rs :eval never-export :results output 
fn main() {println!("TODO");}
#+end_src
** TODO Bash
#+begin_src bash :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.sh :eval never-export :results output 
echo "TODO"
#+end_src
** TODO Awk
#+begin_src awk :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.awk :eval never-export :results output 
BEGIN {print "TODO"}
#+end_src
** TODO Perl
#+begin_src perl :var sample_data=sample-2021-04 :var input_data=input-2021-04 :tangle /tmp/advent_of_code/aoc2021-04-2.pl :eval never-export :results output 
print("TODO\n")
#+end_src
* Inputs
** Sample
...
echo "7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1
...
#+NAME: input-2021-04
#+begin_src bash :results output :cache yes :eval never-export
echo "57,9,8,30,40,62,24,70,54,73,12,3,71,95,58,88,23,81,53,80,22,45,98,37,18,72,14,20,66,0,19,31,82,34,55,29,27,96,48,28,87,83,36,26,63,21,5,46,33,86,32,56,6,38,52,16,41,74,99,77,13,35,65,4,78,91,90,43,1,2,64,60,94,85,61,84,42,76,68,10,49,89,11,17,79,69,39,50,25,51,47,93,44,92,59,75,7,97,67,15
