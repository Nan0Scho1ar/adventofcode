...
***** Racket
#+begin_src racket :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2.rkt :results output
...
;;     (define str (caddr l))
;;     (define cnt (count-substring char str))
;;     (when (and (>= cnt min) (<= cnt max))
;;       (set! num (+ num 1))))
;;   num)
...
***** Python
#+begin_src python  :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2.py :results output
...
(define (prepare_data data)
  (for/list ([line (string-split data "\n")])
       (string-split line)))


(define data1 (prepare_data sample_data))
; (define data2 (prepare_data input_data))

(print (check_passwords data1))
