...
***** Racket
#+begin_src racket :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2-1.rkt :results output
...
***** Python
#+begin_src python  :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2-1.py :results output
...
#+begin_src racket :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2-2.rkt :results output
(define (check_passwords data)
  (count identity
         (for/list ([line (string-split data "\n")])
           (define l (string-split line))
...
***** Python
#+begin_src python  :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2-2.py :results output
...
Here is a cursed one liner which does the same thing as above
#+begin_src python  :var sample_data=sample-2020-02 :var input_data=input-2020-02 :tangle /tmp/aoc2020-2-2.py :results output
def check_passwords(input):
...
***** Racket
#+begin_src racket :var sample_data=sample-2020-03 :var input_data=input-2020-03 :tangle /tmp/aoc2020-3-1.rkt :results output
...
***** Python
#+begin_src python  :var sample_data=sample-2020-03 :var input_data=input-2020-03 :tangle /tmp/aoc2020-3-1.py :results output
...
***** Python
#+begin_src python  :var sample_data=sample-2020-03 :var input_data=input-2020-03 :tangle /tmp/aoc2020-3-2.py :results output
import math
